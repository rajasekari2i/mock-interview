...
- Frontend test command: `npx vitest run`
- Frontend coverage command: `npx vitest run --coverage`
...
- TypeScript strict mode for the React frontend; avoid `any` types
- Python type annotations for the FastAPI backend
- ESLint for frontend linting and Ruff for backend linting/formatting
